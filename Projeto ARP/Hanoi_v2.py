...
COLOR = (0.50156, 0, 0.99218)
#TARGET = (0.86328, 0.47656, 0.31250)

turtle.setup(800,600)
turtle.hideturtle()
turtle.title("Torre de Hanoi - Sucess Group")
turtle.speed(0)
turtle.tracer(0,0)
...
draw_scene()
turtle.update()
n = int(turtle.numinput('Número de discos','Digite o número de discos:',5,2,10))
initialize()
draw_rings()
